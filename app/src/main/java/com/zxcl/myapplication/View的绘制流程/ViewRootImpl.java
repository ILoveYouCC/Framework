...
package com.zxcl.myapplication.View的绘制流程;
...
public final class ViewRootImpl implements ViewParent,
    ...
    private final SurfaceControl mBlastSurfaceControl = new SurfaceControl();
    ...
    private boolean hasColorModeChanged(int colorMode) {
        ...
        return !isWideGamut || mContext.getResources().getConfiguration().isScreenWideColorGamut();
    }
    ...
    private static final class QueuedInputEvent {
        ...
        public boolean shouldSendToSynthesizer() {
            return (mFlags & FLAG_UNHANDLED) != 0;
        }
        ...
        private boolean performFocusNavigation(KeyEvent event) {
            ...
            if (direction != 0) {
                ...
                if (focused != null) {
                    ...
                    return mView.dispatchUnhandledMove(focused, direction);
                } else {
                    return mView.restoreDefaultFocus();
                }
            }
