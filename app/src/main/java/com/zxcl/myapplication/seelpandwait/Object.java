...
package com.zxcl.myapplication.seelpandwait;
...
public class Object {
     ...
     * <p> 在当前线程放弃对该对象的锁定之前，被唤醒的线程将无法继续。
     * 被唤醒的线程将以通常的方式与可能正在积极竞争以在该对象上同步的任何其他线程竞争；
     * 例如，被唤醒的线程在成为下一个锁定该对象的线程时不享有可靠的特权或劣势。
     * <p> 此方法只能由作为该对象监视器所有者的线程调用。
