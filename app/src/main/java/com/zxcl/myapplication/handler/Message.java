...
package com.zxcl.myapplication.handler;
...
public final class Message implements Parcelable {
     ...
     * 用户自定义消息码 以便 接收者能够 确认这个消息是干啥的。
     *
     * Each {@link Handler} has its own name-space for message codes, so you do not need to worry about yours conflicting with other handlers.
     * 每个 Handler 对于这个消息码有它自己的命名空间，所以你不用担心冲突。
     */
    public int what;
     ...
     * few integer values.
     *
     * arg1 和 arg2 是 setData 的备选方法，低消耗。如果你只是存储一些 int 值。
     */
    public int arg1;
     ...
     * 用于消息分发时间，基于 SystemClock.uptimeMillis 手机开机时间，不包含深度睡眠时间
     */
    @UnsupportedAppUsage
    ...
    /**
     * 在 enqueueMessage 的是否赋值，用来存储发送消息的Handler
     */
    @UnsupportedAppUsage
